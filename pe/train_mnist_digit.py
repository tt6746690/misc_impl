...
def train(
    ...
    model = models.MnistCNN(3, 10, 32).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_root", type=str, default='./models/mnist_digit_classifier', help="model folder")
    parser.add_argument("--log_root", type=str, default=f'./logs/mnist_digit_classifier', help="log folder")
    parser.add_argument("--model_name", type=str, default='mnist_digit_classifier', help="name of the model")
