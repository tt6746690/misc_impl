...
\begin{example}
    ...
    \begin{align}
        \widetilde{\bK}_{ij}
            ...
            &= \bK_{ij} - \mathbf{1}_n \bK - \bK\mathbf{1}_n + \mathbf{1}_n \bK \mathbf{1}_n
    \end{align}
    where $\mathbf{1}_n \in \R^{n\times n}$ defined as $(\mathbf{1}_n)_{ij}=\frac{1}{n}$. Therefore, $\widetilde{\bK} = \bH \bK \bH$ where $\bH = \bI - \mathbf{1}_n$ since
    \begin{align}
        \bH\bK\bH
            = ( \bI - \mathbf{1}_n ) \bK ( \bI - \mathbf{1}_n )
            = \bK - \bK \mathbf{1}_n - \mathbf{1}_n \bK + \mathbf{1}_n \bK \mathbf{1}_n
    \end{align}
\end{example}
